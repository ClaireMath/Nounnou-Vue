  ...
  <div class="myFooter">
        <div class="box1">
            ...
            <div class="ubox1">
                ...
                <router-link to="/alimentsdangereux">Aliments dangereux pour nos matous</router-link>
                <router-link to="/objetsutiles">Objets vraiment utiles</router-link>
            </div>
            <div class="ubox2">
                <h4>Contactez-nous</h4>
                
                <p><a href="mailto:claira.m@live.fr">claira.m@live.fr</a></p>
                <div class="divtel">
                    <p class="texttel" >Téléphone :</p>
                    <p class="texttel">01 41 78 83 49</p>
                </div>
                <div class="subbox">
                    <a href="https://fr-fr.facebook.com"><img src="../assets/fb.png" alt="logo facebook" class="logo"></a>
                    <a href="https://www.instagram.com"><img src="../assets/insta.png" alt="logo instagram" class="logo"></a>
                    <a href="https://www.pinterest.com"><img src="../assets/pinterest.png" alt="logo pinterest" class="logo"></a>
                </div>
            </div>
        </div>
        <div class="box2">
                <p class="ml">CGU - Mentions légales</p>
                <p class="ml">Une Nounou pour mon Matou <img src="../assets/copyright.png" width="15px" height="15px"></p>
        </div> 
  </div>
</template>
